...
function Button({
  ...
  (0, import_react.useEffect)(() => {
    if (type === 'solid') {
      const designValue = solid.filter((val) => val.variant === variant);
      setStyle(designValue[0]['style'] || '');
    }
    if (type === 'outline') {
      const designValue = outline.filter((val) => val.variant === variant);
      setStyle(designValue[0]['style'] || '');
    }
    if (type === 'translucent') {
      const designValue = translucent.filter((val) => val.variant === variant);
      setStyle(designValue[0]['style'] || '');
    }
  }, [variant, type]);
...
function Radio({ value = '', valueGroup = '', onChange, label }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)('label', {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)('div', {
        className:
          'inline-block peer-checked:[&>*]:bg-primary-700 w-6 h-6 bg-black-100 peer-checked:bg-transparent rounded-full p-[1.1px] border-solid border-[1px] border-black-800',
      ...
      label
        ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)('div', {
            className:
              'inline-block leading-[24px] h-[24px] translate-y-[-7px] ml-2 mr-2',
            children: 'test',
          })
        : '',
    ],
...
function Modal({ children, title, style }) {
  (0, import_react4.useEffect)(() => {
    var _a;
    (_a = document.querySelector('body')) == null
      ? void 0
      : _a.classList.add('overflow-hidden');
    return () => {
      var _a2;
      (_a2 = document.querySelector('body')) == null
        ? void 0
        : _a2.classList.remove('overflow-hidden');
    };
  }, []);
    ...
    import_jsx_runtime4.Fragment,
    {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)('div', {
          className:
            'w-full h-[100vh] fixed top-0 left-0 z-30 bg-black-900 opacity-25',
        }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)('div', {
          className: [
              ...
              title
                ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)('div', {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                      'span',
                      { className: 'text-base font-bold', children: title }
                    ),
                  })
                : '',
...
function TooltipContent({ tipLocation = 'top', children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)('div', {
    className:
      'bg-black-100 mt-2 py-1 pl-2 pr-4 shadow-[0_0_4px_rgba(29,171,221,0.2)] w-fit whitespace-nowrap rounded-sm dark:text-black-900 after:absolute after:left-[1px] ' +
...
function Tooltip({ direction = 'bottom', tooltipContent, children }) {
  const [tooltipDirection, setTooltipDirection] = (0, import_react5.useState)(
    'top'
  );
  ...
  (0, import_react5.useEffect)(() => {
    var _a, _b;
    if (
      typeof ((_a = tooltipWrapper.current) == null
        ? void 0
        : _a.clientWidth) === 'number'
    ) {
      setHalfWidth(
        Math.trunc(
          ((_b = tooltipWrapper.current) == null ? void 0 : _b.clientWidth) / 2
        )
      );
    }
  }, []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)('div', {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TooltipContent, {
  ...
  switch (type) {
    case 'error':
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        import_shared_icon.IcError,
        {}
      );
    case 'info':
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        import_shared_icon.IcInfo,
        {}
      );
    case 'warning':
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        import_shared_icon.IcWarning,
        {}
      );
    case 'success':
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        import_shared_icon.IcChecked,
        {}
      );
    default:
      return null;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)('div', {
    ...
    children: isShown
      ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          import_react_awesome_reveal.Fade,
          {
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)('div', {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SnackbarIcon, {
                  type: image,
                }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)('p', {
                  className: 'text-base translate-y-[2px] min-w-[10rem] block',
                  children: children
                    ? children
                ...
                !timer
                  ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)('button', {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                        import_shared_icon.IcSnackbarClose,
                        {}
                      ),
                    })
                  : '',
...
function Dropdown({
  ...
  const [inputOptions, setInputOptions] = (0, import_react7.useState)([
    ...options,
  ]);
  const handleFocus = () => {
    setIsOpen(!isOpen);
  ...
  const optionHtml = inputOptions.map((value2, idx) => {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      'button',
      {
        ...
        className:
          'w-full text-left cursor-pointer list-inside leading-6 border-b-[1px] border-black-500 hover:bg-black-400',
  ...
  (0, import_react7.useEffect)(() => {
    ...
    if (type === 'combobox') {
      const filterOptions = options.filter((data) =>
        data.label
          .toLowerCase()
          .includes((value == null ? void 0 : value.toLowerCase()) || '')
      );
      setInputOptions(filterOptions);
    }
  }, [value]);
        ...
        children: [
          ...
          type === 'dropdown' &&
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
              import_shared_icon2.IcArrow,
              {
                className:
                  'z-1 absolute left-full top-[13px] -translate-x-[28px] transition-transform peer-focus:transition-transform peer-focus:rotate-180',
              }
            ),
          isOpen && inputOptions.length > 0
            ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                import_react_awesome_reveal2.Fade,
                {
                  children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
                    'div',
                    {
                      className:
                        'w-full bg-black-100 absolute mt-2 p-[12px_5px_7px_5px] overflow-y-scroll max-h-32 scrollbar-thin scrollbar-thumb-black-500 scrollbar-track-dark-100 scrollbar-thumb-rounded-full scrollbar-track-rounded-full shadow-[0px_1px_4px_rgba(0,0,0,0.25)]',
                      children: [
                        ...
                        type === 'dropdown'
                          ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                              'button',
                              {
                                ...
                                className:
                                  'w-full text-left text-black-700 cursor-pointer list-inside leading-6 border-b-[1px] border-black-500 hover:bg-black-400',
...
function Checkbox({ value = '', valueList = [], onChange, label }) {
  ...
  const onChangeAction = (event) => {
    ...
    const results =
      (valueList == null
        ? void 0
        : valueList.filter((data) => data !== value2)) || [];
    if (checked) {
      results.push(value2);
    }
    onChange(results);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)('label', {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)('div', {
        className:
          'inline-block w-[24px] h-[24px] bg-black-100 border-solid border-[1px] border-black-800 rounded-[3px] peer-checked:bg-primary-800 peer-checked:border-primary-800 p-[6px_3px_4px_1px] peer-checked:drop-shadow-[0px_1px_4px_#6F9DF8]',
        children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          import_shared_icon3.IcCheckboxCheck,
          {}
        ),
      }),
      label
...
var Textarea = import_react9.default.forwardRef(function Textarea2(
  ...
  (0, import_react9.useEffect)(() => {
    setSumCharacters(document.getElementById(inputId).value.length);
  }, [register == null ? void 0 : register.ref]);
  (0, import_react9.useEffect)(() => {
    let tmpVal = value;
    if (register) tmpVal = document.getElementById(inputId).value;
    if (limit && tmpVal) {
      let inputLength = 0;
  ...
  const onChangeTextarea = (event) => {
    ...
    if (!(sumCharacters === 0 || tmpEvent.target.value.length <= limit)) {
      document.getElementById(inputId).value = tmpEvent.target.value.substring(
        0,
        limit
      );
      return;
  ...
  const conditionalOnBlur = (val) => {
    if (!val) return;
    if (register == null ? void 0 : register.onBlur) register.onBlur(val);
    ...
    children: [
      ...
      limit
        ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)('span', {
            ...
            children: [sumCharacters, '/', limit, ' Characters'],
          })
        : '',
    ],
  });
